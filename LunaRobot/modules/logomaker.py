...
from LunaRobot import OWNER_ID, SUPPORT_CHAT
from LunaRobot.events import register
from LunaRobot import telethn
...
async def lego(event):
 ...
 try:
    ...
    fname = "Sophia.jpg"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by @Dark_phoenix_bot")         
    await pesan.delete()
